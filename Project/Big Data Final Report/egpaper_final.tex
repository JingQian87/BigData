...
\end{tabular}
\end{center}
\caption{ANOVA result for Septicemia in New York State. Significant codes: '***' 0.001.}
\end{table}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
